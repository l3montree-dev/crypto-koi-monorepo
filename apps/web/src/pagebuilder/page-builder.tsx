        ...
        switch (item.__component) {
            ...
            case 'general.get-your-koi-section':
                return (
                    <GetYourKoi
                        {...item}
                        key={'page.get-your-koi-section-' + item.id}
                    />
                )
            case 'page.story':
            ...
            case 'page.onboarding-story':
                return (
                    <Onboarding
                        {...item}
                        key={'page.onboarding-story-' + item.id}
                    />
                )
            ...
            case 'page.image-text-cards':
                return (
                    <ImageTextCards
                        {...item}
                        key={'page.image-text-cards-' + item.id}
                    />
                )
            case 'page.title-text':
                return (
                    <TitleText {...item} key={'page.title-text-' + item.id} />
                )
            default:
                return null
        }
